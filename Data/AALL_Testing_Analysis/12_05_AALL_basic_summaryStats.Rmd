---
title: "12_14_AALL_basic_summaryStats"
...
#write.csv(data_subj, "AALL_Saved.csv")
#print(data_subj)
```
...
```
```{r}
# Testing to exclude participants who are not performing significantly above chance 
...
#write.csv(subject_accuracy, "12_14_binomial_test.csv")
```
