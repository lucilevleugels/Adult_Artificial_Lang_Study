...
combined_df.to_csv('train_v2.csv',index=False)
...
test_cond_iso_l = combined_df[combined_df['condition']=='isolated-left']
test_cond_iso_c = combined_df[combined_df['condition']=='isolated-center']
test_cond_iso_r = combined_df[combined_df['condition']=='isolated-right']
...
final_test_df.to_csv('test_v2.csv',index=False)
